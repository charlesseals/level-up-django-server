...
class GameTests(APITestCase):
    ...
    def test_create_game(self):
        ...
        self.assertEqual(json_response["skill_level"], "Medium")
    ...
    def test_change_game(self):
        ...
        self.assertEqual(json_response["number_of_players"], 10)
    ...
    def test_delete_game(self):
        ...
        game.number_of_players = 10
        game.gamer_id = 1
        game.description = "Super Fun Game!"
        game.save()
